...
## v32 baseline + v32.1 patch additions
- Added **WIND** tile (GUST ≥25KT) and **SNOW** tile (SN/SHSN).
- Added filter option **GUST ≥25KT** and highlight class for gust groups ≥25KT.
